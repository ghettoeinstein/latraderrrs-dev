...
/* Design credit */
.footer-credit{text-align:center;padding:20px 0 24px;border-top:1px solid var(--line);}
.footer-credit .credit-text{font-family:var(--font-mono);font-size:11px;letter-spacing:2px;text-transform:uppercase;color:var(--ash-dim);}
.footer-credit .credit-text a{font-weight:700;font-size:13px;letter-spacing:1px;color:var(--gold-bright);text-transform:none;transition:color var(--dur-fast);text-decoration:none;}
.footer-credit .credit-text a:hover{color:var(--gold);}
.footer-credit .credit-heart{color:var(--red);font-size:14px;}
"""
    ...
    <div class="mega-item">
      ...
      <div class="mega-dropdown">
        <div class="mega-col">
          <h5>Gumroad Store</h5>
          <ul>
            <li><a href="https://latraderrrs.gumroad.com/l/rrr-os-lite" target="_blank" rel="noopener noreferrer">RRR OS Lite — $17</a></li>
            <li><a href="https://latraderrrs.gumroad.com/l/rrr-checklist" target="_blank" rel="noopener noreferrer">Free Checklist</a></li>
            <li><a href="https://latraderrrs.gumroad.com/l/tradingroom" target="_blank" rel="noopener noreferrer">Trading Room (Discord)</a></li>
          </ul>
        </div>
      </div>
    </div>
  </div>
  <a href="https://latraderrrs.gumroad.com/l/tradingroom" target="_blank" rel="noopener noreferrer" class="nav-cta nav-discord mega-nav-cta">Join the Trading Room</a>
</nav>
"""
  ...
  <div class="wrap">
    ...
    <div class="footer-legal">
      ...
      <div class="flinks">
        ...
        <a href="https://latraderrrs.gumroad.com/l/tradingroom" target="_blank" rel="noopener noreferrer">Trading Room</a>
        <a href="/terms/">Terms of Service</a>
        <a href="/privacy/">Privacy Policy</a>
      </div>
    </div>
    <div class="footer-credit">
      <span class="credit-text">Designed by <a href="https://calebpierre.com" target="_blank" rel="noopener">Caleb Pierre</a> — made with <span class="credit-heart">♥</span> in Gardena by <a href="https://calebpierre.com" target="_blank" rel="noopener">Calebpierre.com</a></span>
    </div>
